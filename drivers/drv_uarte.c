...
drv_uart_cb_t m_uarte0_cb = {.uarte_instance = NRFX_UARTE_INSTANCE(0),
                             .rx_length = 0,
...
drv_uart_cb_t m_uarte1_cb = {.uarte_instance = NRFX_UARTE_INSTANCE(1),
                             .rx_length = 0,
...
drv_uart_cb_t m_uarte2_cb = {.uarte_instance = NRFX_UARTE_INSTANCE(2),
                             .rx_length = 0,
...
drv_uart_cb_t m_uarte3_cb = {.uarte_instance = NRFX_UARTE_INSTANCE(3),
                             .rx_length = 0,
...
static rt_err_t _uart_cfg(struct rt_serial_device *serial,
  ...
  nrfx_uarte_init(&(p_cb->uarte_instance), (nrfx_uarte_config_t const *)&config,
                  uarte_evt_handler);
...
static rt_err_t _uart_ctrl(struct rt_serial_device *serial, int cmd,
                           void *arg) {
  drv_uart_cb_t *p_cb = RT_NULL;
  RT_ASSERT(serial != RT_NULL);
...
static struct rt_uart_ops _uart_ops = {_uart_cfg, _uart_ctrl, _uart_putc,
                                       _uart_getc};
