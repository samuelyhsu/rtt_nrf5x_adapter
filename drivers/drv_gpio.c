...
static const struct pin_index pins[] = {
    __NRF5X_PIN(0, 0, 0),   __NRF5X_PIN(1, 0, 1),   __NRF5X_PIN(2, 0, 2),
    __NRF5X_PIN(3, 0, 3),   __NRF5X_PIN(4, 0, 4),   __NRF5X_PIN(5, 0, 5),
    __NRF5X_PIN(6, 0, 6),   __NRF5X_PIN(7, 0, 7),   __NRF5X_PIN(8, 0, 8),
    __NRF5X_PIN(9, 0, 9),   __NRF5X_PIN(10, 0, 10), __NRF5X_PIN(11, 0, 11),
    __NRF5X_PIN(12, 0, 12), __NRF5X_PIN(13, 0, 13), __NRF5X_PIN(14, 0, 14),
    __NRF5X_PIN(15, 0, 15), __NRF5X_PIN(16, 0, 16), __NRF5X_PIN(17, 0, 17),
    __NRF5X_PIN(18, 0, 18), __NRF5X_PIN(19, 0, 19), __NRF5X_PIN(20, 0, 20),
    __NRF5X_PIN(21, 0, 21), __NRF5X_PIN(22, 0, 22), __NRF5X_PIN(23, 0, 23),
    __NRF5X_PIN(24, 0, 24), __NRF5X_PIN(25, 0, 25), __NRF5X_PIN(26, 0, 26),
    __NRF5X_PIN(27, 0, 27), __NRF5X_PIN(28, 0, 28), __NRF5X_PIN(29, 0, 29),
    __NRF5X_PIN(30, 0, 30), __NRF5X_PIN(31, 0, 31),
#if defined(SOC_NRF52840) || defined(SOC_NRF5340)
    __NRF5X_PIN(32, 1, 0),  __NRF5X_PIN(33, 1, 1),  __NRF5X_PIN(34, 1, 2),
    __NRF5X_PIN(35, 1, 3),  __NRF5X_PIN(36, 1, 4),  __NRF5X_PIN(37, 1, 5),
    __NRF5X_PIN(38, 1, 6),  __NRF5X_PIN(39, 1, 7),  __NRF5X_PIN(40, 1, 8),
    __NRF5X_PIN(41, 1, 9),  __NRF5X_PIN(42, 1, 10), __NRF5X_PIN(43, 1, 11),
    __NRF5X_PIN(44, 1, 12), __NRF5X_PIN(45, 1, 13), __NRF5X_PIN(46, 1, 14),
    __NRF5X_PIN(47, 1, 15),
...
static rt_err_t nrf5x_pin_dettach_irq(struct rt_device *device,
                                      rt_int32_t pin) {
  const struct pin_index *index;
  rt_base_t level;
  int i;
...
int rt_hw_pin_init(void) {
  ...
  err_code =
      (nrfx_err_t)rt_device_pin_register("pin", &_nrf5x_pin_ops, RT_NULL);
...
void gpio_sample(void) {
  ...
  rt_pin_attach_irq(DK_BOARD_BUTTON_1, PIN_IRQ_MODE_FALLING, button_1_callback,
                    (void *)true); // true: hi_accuracy(IN_EVENT),false:
                                   // lo_accuracy(PORT_EVENT)
  rt_pin_irq_enable(DK_BOARD_BUTTON_1, PIN_IRQ_ENABLE);

  rt_pin_attach_irq(DK_BOARD_BUTTON_2, PIN_IRQ_MODE_FALLING, button_2_callback,
                    (void *)true); // true: hi_accuracy(IN_EVENT),false:
                                   // lo_accuracy(PORT_EVENT)
  rt_pin_irq_enable(DK_BOARD_BUTTON_2, PIN_IRQ_ENABLE);

  rt_pin_attach_irq(DK_BOARD_BUTTON_3, PIN_IRQ_MODE_FALLING, button_3_callback,
                    (void *)true); // true: hi_accuracy(IN_EVENT),false:
                                   // lo_accuracy(PORT_EVENT)
  rt_pin_irq_enable(DK_BOARD_BUTTON_3, PIN_IRQ_ENABLE);

  rt_pin_attach_irq(DK_BOARD_BUTTON_4, PIN_IRQ_MODE_FALLING, button_4_callback,
                    (void *)false); // true: hi_accuracy(IN_EVENT),false:
                                    // lo_accuracy(PORT_EVENT)
