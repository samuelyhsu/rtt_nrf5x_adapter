...
/**
 * @brief Attach the spi device to SPI bus, this function must be used after
 * initialization.
...
#define NRFX_SPI0_CONFIG                                                       \
  { .bus_name = "spi0", .spi = NRFX_SPIM_INSTANCE(0) }
#endif
#ifdef BSP_USING_SPI1
#define NRFX_SPI1_CONFIG                                                       \
  { .bus_name = "spi1", .spi = NRFX_SPIM_INSTANCE(1) }
#endif

#ifdef BSP_USING_SPI2
#define NRFX_SPI2_CONFIG                                                       \
  { .bus_name = "spi2", .spi = NRFX_SPIM_INSTANCE(2) }
#endif

#ifdef BSP_USING_SPI3
#define NRFX_SPI3_CONFIG                                                       \
  { .bus_name = "spi3", .spi = NRFX_SPIM_INSTANCE(3) }
#endif
#ifdef BSP_USING_SPI4
#define NRFX_SPI4_CONFIG                                                       \
  { .bus_name = "spi4", .spi = NRFX_SPIM_INSTANCE(4) }
#endif
...
#ifdef BSP_USING_SPI0
#define NRFX_SPI0_CONFIG                                                       \
  { .bus_name = "spi0", .spi = NRFX_SPI_INSTANCE(0) }
#endif
#ifdef BSP_USING_SPI1
#define NRFX_SPI1_CONFIG                                                       \
  { .bus_name = "spi1", .spi = NRFX_SPI_INSTANCE(1) }
#endif

#ifdef BSP_USING_SPI2
#define NRFX_SPI2_CONFIG                                                       \
  { .bus_name = "spi2", .spi = NRFX_SPI_INSTANCE(2) }
#endif
