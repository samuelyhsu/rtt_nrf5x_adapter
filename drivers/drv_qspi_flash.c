...
static int init(void) {
  ...
  nrfx_qspi_config_t config = NRFX_QSPI_DEFAULT_CONFIG(
      BSP_QSPI_SCK_PIN, BSP_QSPI_CSN_PIN, BSP_QSPI_IO0_PIN, BSP_QSPI_IO1_PIN,
      BSP_QSPI_IO2_PIN, BSP_QSPI_IO3_PIN);
...
struct fal_flash_dev nor_flash0 = {.name = NOR_FLASH_DEV_NAME,
                                   .addr = 0,
